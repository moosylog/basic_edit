...
A lightweight, zero-dependency visual editor that serves as a true foundation for building custom keyboard utilities. By providing the exact hardware geometry coordinates needed to render the physical keyboard matrix on screen, it gives you a ready-made playground to start tinkering with **MoErgo (Glove80 and Go60)** ZMK JSON configurations right out of the box.
